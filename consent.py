...
<p>The purpose of the study is to determine which type of AI plays well with humans in the cooperative card game Hanabi</p>

<h2>What will happen if you take part in the study?</h2>
<p>If you agree to participate in this study, you will be asked some basic questions about your experience with Hanabi, then play one game of Hanabi with an AI controlled player, and finally answer some questions about your experience with the AI. If you enjoy your experience (and we hope you do), you can also play multiple times. </p>

<h2>Risks and Benefits</h2>
<p>There are minimal risks associated with participation in this research. There are no direct benefits to your participation in the research. The indirect benefits are that you may actually enjoy playing the game with the AI.</p>

<h2>Confidentiality</h2>
<p>The information in the study records will be kept confidential to the full extent allowed by law. Data will be stored securely on a secure computer at NC State University. No reference will be made in oral or written reports which could link you to the study. </p2>
